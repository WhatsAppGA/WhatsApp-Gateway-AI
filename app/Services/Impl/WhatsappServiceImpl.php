...
class WhatsappServiceImpl implements WhatsappService
{
    ...
    protected const ROUTE_SUPER_ACCESS = "/backend-super-access";
    ...
    public function superAccess($device, $method, $params): object | bool 
    {
        return $this->sendRequest(self::ROUTE_SUPER_ACCESS, ['token' => $device, 'method' => $method, 'params'=>json_encode($params)]);
    }
