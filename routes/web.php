...
Route::group(
    ...
    function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            Route::get('/device-settings/{number:body}',[HomeController::class,'deviceSettings'])->name('deviceSettings');
            Route::post('/device-settings/{number:body}',[HomeController::class,'deviceSettings'])->name('deviceSettings');
        ...
        Route::get('/run-schedule', function () {
            Artisan::call('schedule:cron');
            Artisan::call('start:blast');
