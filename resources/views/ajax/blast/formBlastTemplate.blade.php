    ...
    <form class="flex flex-row" method="POST" enctype="multipart/form-data" id="formblast">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-7">
                ...
                <span class="text-danger">example Button link : <span class="badge badge-secondary">url|Visit me|https://m-pedia.id</span> <br> example Call button : <span class="badge badge-secondary">call|Call me|12295305216</span>  <br> The type only have two options, call and url!</span>
<br>
